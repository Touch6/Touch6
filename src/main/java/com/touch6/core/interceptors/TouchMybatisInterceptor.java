package com.touch6.core.interceptors;
...
public class TouchMybatisInterceptor implements Interceptor {
    private static final Logger logger = LoggerFactory.getLogger(TouchMybatisInterceptor.class);
